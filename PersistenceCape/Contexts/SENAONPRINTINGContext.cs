    ...
    public partial class SENAONPRINTINGContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ClientModel>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__clients__AB6E6164EB24A26E")
                    .IsUnique();
            ...
            modelBuilder.Entity<ProviderModel>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__provider__AB6E6164C311C85B")
                    .IsUnique();
            ...
            modelBuilder.Entity<UserModel>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__users__AB6E61646884B979")
                    .IsUnique();

                entity.HasIndex(e => e.DocumentNumber, "UQ__users__C8FE0D8C51A0A0B5")
                    .IsUnique();
